console.warn(`In fisierul din director se afla cod HTML pentru crearea unei mici aplicatii interactive in care
casuta neagra poate fi mutata cu o animatie, folosind butoanele de control
Seteaza informatia CSS pentru a pregati elementul hero pentru a tranzitiona proprietatile top si left
Prin citirea valorii curente ale celor doua proprietati (element.style.top, element.style.left)
si scaderea sau adunarea a 30 de pixeli, elementul poate fi apoi mutat prin animatie folosind element.setAttribute('style', 'left: valoare;')
Creeaza codul necesar pentru a putea controla patratul negru folosind butoanele de jos`);
